...
Use AskUserQuestion:
```
question: "Where is your brief? I can read from:"
options:
  - "Paste it here — I'll copy the content into this chat"
  - "A URL (Notion, Confluence, Google Docs, etc.)"
  - "A Figma file — share the link"
  - "A local file path"
```

- **Paste** → ask user to paste, then extract and structure the content
- **URL** → read the URL, extract key sections
- **Figma** → use figma_get_metadata and figma_get_design_context to read context
- **File path** → read the file

After ingesting, extract and summarize:
```
## Brief Summary
- Product: <name and one-line description>
- Target user: <who>
- Core problem: <what problem this solves>
- Key flows: <list of main user flows>
- Platforms: <web, mobile, tablet, etc.>
- Constraints: <technical, timeline, brand, etc.>
- Success metrics: <how we know it worked>
```

Present summary and ask:
```
question: "Does this summary capture the project correctly?"
options:
  - "Yes, looks good"
  - "Let me correct a few things"
```

If "correct" → ask what to fix, update summary.
