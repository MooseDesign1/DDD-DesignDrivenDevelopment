...
- `projects/<slug>/design/active_session.md` — current phase and checkpoint
...
Write `projects/<slug>/design/research.md`:
```markdown
...
Research saved to projects/<slug>/design/research.md
...
`/pd:define` — Map out user flows and build your screen inventory
